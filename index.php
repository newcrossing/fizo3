...
<div class="container">
    <div class="py-5 text-center">
        ...
        <p class="lead">По физической подготовке Военнослужащим Минобороны.</p>
    </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-6">
                    ...
                    <select class="form-select" id="age" required="">
                        ...
                        <option value="6" forsex="m">45 - 49</option>
                        <option value="6" forsex="w" style="display: none">45 и старше</option>
                        <option value="7" forsex="m">50 - 54</option>
                        <option value="8" forsex="m">55 и старше</option>
                    </select>
                ...
                <div class="col-8">
                    ...
                    <select class="form-select" id="upr_select_1" required="" numuprselect="1">
                        ...
                        <option value="57a" forsex="m">Упр. № 57,а (Плавание 50 м вольным стилем)</option>
                        <option value="57a" forsex="w" style="display:none ">Упр. № 57,а (Плавание 50 м)</option>
                        <option value="57b" forsex="m">Упр. № 57,б (Плавание 500 м вольным стилем)</option>
                        <option value="57b" forsex="w" style="display: none">Упр. № 57,б (Плавание 300)</option>
                        <!-- <option value="58" style="display:none ">Упр. № 58 (Плавание 100 м способом брасс)</option>-->
                        <!-- <option value="51" forsex="m" style="display:none ">Упр. № 51 (Тройной прыжок с места)</option>
 -->
                ...
                <div class="col-8">
                    ...
                    <select class="form-select" id="upr_select_2" required="" numuprselect="2">
                        <option value="1" selected="selected">Упр. № 1 (Cгибание и разгибание рук в упоре лежа)</option>
                        <option value="2">Упр. № 2 (Наклоны туловища вперед)</option>
                        <option value="4" forsex="m">Упр. № 4 (Подтягивание на перекладине)</option>
                        <option value="5" forsex="m">Упр. № 5 (Поднимание ног к перекладине)</option>
                        <option value="6" forsex="m">Упр. № 6 (Подъем переворотом на перекладине)</option>
                        <option value="7" forsex="m">Упр. № 7 (Подъем силой на перекладине)</option>
                        <option value="8_1" forsex="m">Упр. № 8 (Жим штанги 70 кг. лёжа (вес до 70 кг)</option>
                        <option value="8_2" forsex="m">Упр. № 8 (Жим штанги 70 кг. лёжа (вес свыше 70 кг)</option>
                        <option value="9" forsex="m">Упр. № 9 (Сгибание и разгибание рук в упоре на брусьях)</option>
                        <!--<option value="10" forsex="m" style="display:none ">Упр. № 10 (Угол в упоре на брусьях)</option>-->
                        <option value="11_1" forsex="m">Упр. № 11 (Рывок гири 24 кг (вес до 70 кг)</option>
                        <option value="11_2" forsex="m">Упр. № 11 (Рывок гири 24 кг (вес свыше 70 кг)</option>
                        <option value="12_1" forsex="m">Упр. № 12 (Толчок двух гирь 24 кг (вес до 70 кг)</option>
                        <option value="12_2" forsex="m">Упр. № 12 (Толчок двух гирь 24 кг (вес свыше 70 кг)</option>
                        <option value="13_1" forsex="m">Упр. № 13 (Толчок двух гирь по длинному циклу 24 кг (вес до 70
                            кг)
                        </option>
                        <option value="13_2" forsex="m">Упр. № 13 (Толчок двух гирь по длинному циклу 24 кг (вес свыше
                            70 кг)
                        </option>
                        <option style="display: none;" value="62" forsex="w">Упр. № 62 (Приседание)</option>
                    </select>
                ...
                <div class="col-8">
                    ...
                    <select class="form-select" id="upr_select_3" required="" numuprselect="3">
                        ...
                        <option value="46" forsex="m">Упр. № 46 (Бег на 3 км)</option>
                        <option value="47" forsex="m">Упр. № 47 (Бег на 5 км)</option>
                        <option value="48" forsex="m">Упр. № 48 (марш-бросок на 5 км)</option>
                        <option value="43" forsex="m">Упр. № 43 (Бег 400 м) !!! в секундах !!!</option>
                        <option value="53">Упр. № 53 (Лыжная гонка на 5 км)</option>
                        <option value="54" forsex="m">Упр. № 54 (Лыжная гонка на 10 км)</option>
                        <option value="57b" forsex="w" style="display: none;">Упр. № 57 б (Плавание на 300 м)</option>
                        <option value="57b" forsex="m">Упр. № 57 б (плавание на 500 м вольным стилем)</option>
                    </select>
                ...
                <div class="col-8" id="upr_4_div1" style="display: none">
                    ...
                    <select class="form-select" id="upr_select_4" required="" numuprselect="4">
                        ...
                        <option value="25" forsex="m">Упр. № 25 (обороты вперед - назад на лопинге)</option>
                        <option value="52" forsex="m">Упр. № 52 (Метание гранаты на дальность)</option>
                        <option value="60" forsex="m">Упр. №60 (Ныряние в длину)</option>
                    </select>
                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <iframe width="220" height="100"
                                src="https://widget.qiwi.com/widgets/big-button-220x100?publicKey=48e7qUxn9T7RyYE1MVZswX1FRSbE6iyCj2gCRwwF3Dnh5XrasNTx3BGPiMsyXQFNKQhvukniQG8RTVhYm3iPq1vPyF7MHbdmuGf99Rp2qcYHpTSaaUbo9tzEWSWgFgz7xMKMWW334yQyaM73ESf8yxNdqwdXbk9wGkDDNzz8mvDcWm61xdLRp3DXXTFsn"
    ...
    <footer class="my-5 pt-5 text-muted text-center text-small">
        ...
        <ul class="list-inline">
            ...
            <li class="list-inline-item">
                ...
                <a class="text-muted " href="https://t.me/+wqKMi-UMbnRmY2I6">Нашли ошибку?</a>
            </li>
